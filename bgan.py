...
class BDCGAN(object):
    ...
    def initialize_wgts(self, scope_str):
        ...
        with tf.variable_scope(scope_str) as scope:
            ...
            # TODO: why priors p(theta_x) parametrized by alpha_x?
            return param_list
    ...
    def discriminator(self, image, K, disc_params, train=True):
        """In our case this is D(C; theta_d), theta_d are basically weights of this neural network (disc_params)"""
    ...
    def generator(self, z, gen_params):
        """In our case this is G(I^LR; theta_g), theta_g are basically weights of this neural network (gen_params)"""
